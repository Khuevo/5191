...
<xsl:template match="/">
 ...
 <body>
  <h1>25 Countries You Can't Wait to Discover Now</h1>
	...
	<h2>Disclaimer:</h2>
		<ul>
			<li>Structure: The countries are originally listed in Alphabetic order. However, to maximize your information browsing, the column of Country and Continent are sortable alphabetically.</li>
  ...
  <table border="1">
    ...
    <xsl:for-each select="countrylisting/country-list/country">
